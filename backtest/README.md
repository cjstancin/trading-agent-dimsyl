...
and measures whether the *plumbing* behaves: sizing, the 10% portfolio-heat cap, ATR(22)×3 Chandelier
...
survivorship/look-ahead caveats. Latest run: **half SPY's drawdown (−16.8% vs −33.7%), better Sharpe
(0.74 vs 0.66) and Calmar (0.72 vs 0.46), heat cap never breached (peak 8.7% vs 10% ceiling)** — the
safety layer works; the LLM only has to beat a trend baseline at name selection.
